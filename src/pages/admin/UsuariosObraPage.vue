<template>
  <q-page class="q-pa-xl min-table">
    <div class="row justify-between">
      <div v-if="permissionWrite('37')" class="col q-gutter-sm">
        <q-btn
          class="col"
    ...
    <q-table
      ...
      title="Usuarios de la Editorial"
      dense
...
import FormDialog from "../../components/admin/UsuariosEditorial/FormDialog.vue";
import confirmDelete from "../../components/admin/generals/confirmDialog.vue";
import { useCounterStore } from "../../stores/example-store";
export default {
  name: "UsuariosObrasPage",
  components: {
    FormDialog,
  },
  setup() {
    ...
    async function deleteOperation(id) {
      $q
        ...
        .onOk(async () => {
          ...
          try {
            const response = await api.post("/usuariosObra/eliminar", {
              usuario: selected.value,
            });
